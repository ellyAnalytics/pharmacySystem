 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
      ...
      <div class=" navbar-inner">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="brand" href="#"><b>Madawa Pharmacy System</b></a>
 ...
 <div class="container">
    ...
    <div class="row">
      ...
      <i class="icon-calendar icon-large"></i>
                <?php
                $Today = time(); // Get the current timestamp using time() function
                $new = date('l, F d, Y', $Today); // Format the timestamp using date() function
                echo $new;
                ?><br><br>
